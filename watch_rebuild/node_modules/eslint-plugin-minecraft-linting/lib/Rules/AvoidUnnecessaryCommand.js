...
function isClassRecommendation(recommendation) {
    return 'class' in recommendation;
}
function isApiRecommendation(recommendation) {
    return 'api' in recommendation;
}
// function is
const SCRIPT_RECOMMENDATION = new Map([
    [
        '/setblock',
        {
            module: '@minecraft/server',
            message: 'See https://learn.microsoft.com/en-us/minecraft/creator/scriptapi/minecraft/server/block#setpermutation for more information.',
    ...
    [
        ...
        {
            module: '@minecraft/server',
            message: 'See https://learn.microsoft.com/en-us/minecraft/creator/scriptapi/minecraft/server/blockpermutation#matches for more information.',
    ...
    [
        ...
        {
            module: '@minecraft/server',
            message: 'See https://learn.microsoft.com/en-us/minecraft/creator/scriptapi/minecraft/server/camera#setcamera for more information.',
    ...
    [
        ...
        {
            module: '@minecraft/server',
            message: 'See https://learn.microsoft.com/en-us/minecraft/creator/scriptapi/minecraft/server/container#clearall for more information.',
    ...
    [
        ...
        {
            module: '@minecraft/server',
            message: 'See https://learn.microsoft.com/en-us/minecraft/creator/scriptapi/minecraft/server/player#inputpermissions for more information.',
    ...
    [
        ...
        {
            module: '@minecraft/server',
            message: 'See https://learn.microsoft.com/en-us/minecraft/creator/scriptapi/minecraft/server/container for more information.',
    ...
    [
        ...
        {
            module: '@minecraft/server',
            message: 'See https://learn.microsoft.com/en-us/minecraft/creator/scriptapi/minecraft/server/dimension#getentities for more information.',
    ...
    [
        ...
        {
            module: '@minecraft/server',
            message: 'See https://learn.microsoft.com/en-us/minecraft/creator/scriptapi/minecraft/server/dimension#setweather for more information.',
    ...
    [
        ...
        {
            module: '@minecraft/server',
            message: 'See https://learn.microsoft.com/en-us/minecraft/creator/scriptapi/minecraft/server/player#setweather for more information.',
            api: 'Dimension.setWeather',
        },
    ],
    [
        ...
        {
            module: '@minecraft/server',
            message: 'See https://learn.microsoft.com/en-us/minecraft/creator/scriptapi/minecraft/server/dimension#spawnentity for more information.',
    ...
    [
        ...
        {
            module: '@minecraft/server',
            message: 'See https://learn.microsoft.com/en-us/minecraft/creator/scriptapi/minecraft/server/dimension#spawnparticle for more information.',
    ...
    [
        ...
        {
            module: '@minecraft/server',
            message: 'See https://learn.microsoft.com/en-us/minecraft/creator/scriptapi/minecraft/server/entity#addeffect for more information.',
    ...
    [
        ...
        {
            module: '@minecraft/server',
            message: 'See https://learn.microsoft.com/en-us/minecraft/creator/scriptapi/minecraft/server/entity#addtag for more information.',
            api: 'Entity.addTag',
        },
    ],
    [
        ...
        {
            module: '@minecraft/server',
            message: 'See https://learn.microsoft.com/en-us/minecraft/creator/scriptapi/minecraft/server/entity#applydamage for more information.',
    ...
    [
        ...
        {
            module: '@minecraft/server',
            message: 'See https://learn.microsoft.com/en-us/minecraft/creator/scriptapi/minecraft/server/entity#kill for more information.',
            api: 'Entity.kill',
        },
    ],
    [
        ...
        {
            module: '@minecraft/server',
            message: 'See https://learn.microsoft.com/en-us/minecraft/creator/scriptapi/minecraft/server/entity#teleport for more information.',
            api: 'Entity.teleport',
        },
    ],
    [
    ...
    [
        ...
        {
            module: '@minecraft/server',
            message: 'See https://learn.microsoft.com/en-us/minecraft/creator/scriptapi/minecraft/server/entity#triggerevent for more information.',
    ...
    [
        ...
        {
            module: '@minecraft/server',
            message: 'See https://learn.microsoft.com/en-us/minecraft/creator/scriptapi/minecraft/server/player#addexperience for more information.',
    ...
    [
        ...
        {
            module: '@minecraft/server',
            message: 'See https://learn.microsoft.com/en-us/minecraft/creator/scriptapi/minecraft/server/screendisplay for more information.',
    ...
    [
        ...
        {
            module: '@minecraft/server',
            message: 'See https://learn.microsoft.com/en-us/minecraft/creator/scriptapi/minecraft/server/player#playmusic for more information.',
    ...
    [
        ...
        {
            module: '@minecraft/server',
            message: 'See https://learn.microsoft.com/en-us/minecraft/creator/scriptapi/minecraft/server/player#playsound for more information.',
    ...
    [
        ...
        {
            module: '@minecraft/server',
            message: 'See https://learn.microsoft.com/en-us/minecraft/creator/scriptapi/minecraft/server/player#sendmessage for more information.',
    ...
    [
        ...
        {
            module: '@minecraft/server',
            message: 'See https://learn.microsoft.com/en-us/minecraft/creator/scriptapi/minecraft/server/player#setspawnpoint for more information.',
    ...
    [
        ...
        {
            module: '@minecraft/server',
            message: 'See https://learn.microsoft.com/en-us/minecraft/creator/scriptapi/minecraft/server/scoreboard for more information.',
    ...
    [
        ...
        {
            module: '@minecraft/server',
            message: 'See https://learn.microsoft.com/en-us/minecraft/creator/scriptapi/minecraft/server/world#settimeofday for more information.',
    ...
    [
        ...
        {
            module: '@minecraft/server',
            message: 'See https://learn.microsoft.com/en-us/minecraft/creator/scriptapi/minecraft/server/world#sendmessage for more information.',
    ...
    [
        ...
        {
            module: '@minecraft/server',
            message: 'See https://learn.microsoft.com/en-us/minecraft/creator/scriptapi/minecraft/server/world#setdefaultspawnlocation for more information.',
            api: 'World.setDefaultSpawnLocation',
        },
    ],
]);
const AVOID_UNNECESSARY_COMMAND = utils_1.ESLintUtils.RuleCreator(() => 'https://microsoft.com/')({
    name: 'avoid-unnecessary-command',
    meta: {
        type: 'suggestion',
        docs: {
            description: 'Recommends using a script API if there is a script API (or APIs) that provide 1:1 functionality parity with a command that is used.',
        },
        messages: {
            replaceWithScriptMethod: 'The {{ command }} command can be fully replaced with the {{ api }} api in the {{ module }} module. {{ message }}.',
            replaceWithScriptFunctionality: 'The {{ command }} command can be replaced by the functionality in {{ scriptClass }} in the {{ module }}. {{ message }}.',
        },
        schema: [
            {
                type: 'object',
            ...
            CallExpression(node) {
                ...
                switch (invokedCallee.type) {
                    case utils_1.AST_NODE_TYPES.MemberExpression: {
                        ...
                        if (invokedCallee.property.type !== utils_1.AST_NODE_TYPES.Identifier) {
                        ...
                        if (invokedCallee.property.name !== 'runCommand' &&
                        ...
                        switch (argType.type) {
                            ...
                            case utils_1.AST_NODE_TYPES.Identifier: {
                                ...
                                if (templateOrIdentifier.type === utils_1.AST_NODE_TYPES.TemplateLiteral) {
                                    ...
                                    if (firstQuasi.value.raw.length === 0) {
                                        ...
                                        if (firstExpression.type !== utils_1.AST_NODE_TYPES.Identifier) {
                                ...
                                if (templateOrIdentifier.type === utils_1.AST_NODE_TYPES.Identifier) {
                                    ...
                                    while (currentScope) {
                                        ...
                                        for (const variable of variables) {
                                            if (variable.name === identifierName &&
                                                ...
                                                if (variableInit?.type === utils_1.AST_NODE_TYPES.Literal) {
...
exports.default = AVOID_UNNECESSARY_COMMAND;
//# sourceMappingURL=AvoidUnnecessaryCommand.js.map