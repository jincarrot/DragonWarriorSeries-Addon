...
function sassTask(optionsOrCreateSourceModule, postcssPlugins) {
    ...
    return function sass(done) {
        const sass = (0, tryRequire_1.tryRequire)('sass') || (0, tryRequire_1.tryRequire)('node-sass');
        const postcss = (0, tryRequire_1.tryRequire)('postcss');
        const autoprefixer = (0, tryRequire_1.tryRequire)('autoprefixer');
        const postcssRtl = (0, tryRequire_1.tryRequire)('postcss-rtl');
        const clean = (0, tryRequire_1.tryRequire)('postcss-clean');
...
function requireResolvePackageUrl(packageUrl) {
    ...
    return (0, just_task_1.resolveCwd)(fullName) || (0, just_task_1.resolveCwd)(path.join(path.dirname(fullName), `_${path.basename(fullName)}`));
}
